    ...
    return (
      <footer className=" text-black bg-white ">
        <div className="mt-8 sm:ml-20 ml-4">
          <div className="">
            <p id="contact" className="mb-4 pt-8 font-semibold  ">
              CONTACT
            </p>
            <h1 className="md:text-7xl xl:text-8xl mb-12">
              <span>KEEP.IN.</span>
              <span className="font-bold">TOUCH.</span>
            </h1>
            <p className="mb-12 md:text-md 2xl:text-4xl">Start a conversation</p>
            ...
            <div className="flex pb-12">
              <div className="mr-20 md:mr-28 2xl:mr-40">
                <h2 className="md:text-2xl 2xl:text-5xl mb-2">Our office</h2>
                <h1 className="md:text-4xl 2xl:text-7xl mb-2">Stockholm</h1>
                <p className=" md:text-md 2xl:text-4xl mb-2">Bredängsvägen 203</p>
                <p className=" md:text-md 2xl:text-4xl mb-2">12734 Skärholmen</p>
                <p className="md:text-md 2xl:text-4xl mb-12"> Stockholm </p>
